							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										...
										<li><a href="{{ route('search.doctor') }}"><i class="fas fa-angle-double-right"></i> Search Teachers</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										...
										<li><a href=" {{ route('login') }} "><i class="fas fa-angle-double-right"></i>Seller Login</a></li>
										<li><a href=" {{ route('doctorSignUpForm') }} "><i class="fas fa-angle-double-right"></i>Seller Registration</a></li>
                                        <li><a href=" {{route('login')}} "><i class="fas fa-angle-double-right"></i> Buyer Login</a></li>
                                        <li><a href=" {{route('nurse.signup')}} "><i class="fas fa-angle-double-right"></i>Buyer Registration</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->
							...
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="copyright-text">
										<p class="mb-0">&copy; {{ now()->year }} CoSpaceHub .  Developed By
											<a href="#"> Zeba & Teams </a>
										</p>
									</div>
								</div>
