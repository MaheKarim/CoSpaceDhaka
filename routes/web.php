...
Route::group(['as'=>'admin.' , 'prefix' => 'admin', 'namespace' => 'Admin', 'middleware' =>['auth', 'admin']], function() {
    ...
    Route::get('/delete/teacher/{id}', 'DashboardController@destroy_teacher')->name('deleteDoctor');
...
|--------------------------------------------------------------------------
*/
Route::group(['as'=>'doctor.', 'prefix' => 'seller', 'namespace' => 'Doctor', 'middleware' =>['auth', 'doctor']], function() {
...
Route::group(['as'=>'nurse.' ,'prefix' => 'buyer', 'namespace' => 'Nurse', 'middleware' =>['auth', 'nurse']], function() {
    Route::get('dashboard', 'DashboardController@index')->name('dashboard');
...
Route::get('buyer/register',      'Nurse\NurseAuthController@nurseSignUpForm')->name("nurse.signup");
...
|--------------------------------------------------------------------------
*/
Route::get('/search/your/space', 'SearchController@search')->name('search.doctor');
